...
% By Jagjit Sidhu, Nathaniel Starkman, Harrison Winch, & Glenn Starkman
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{Macro Search and Constraints}% (fold)
\label{sec:macro_search_and_constraints}
    ...
    \subsection{Macro Constraints} % (fold)
